...
import cat1 from '../../../Static/Products/Tank-Tops/catalogue/opt/2.webp'
import cat2 from '../../../Static/Products/Tank-Tops/catalogue/opt/1.webp'
...
const index = () => {
    return (
        ...
        <Suspense fallback={<Loader />}>
            ...
            <Helmet>
                <title> Tank Tops - Products - MNM Exports </title>
                <meta
                name="description" 
            ...
            <Navbar />
            <Banner title="Vests/Panels/Tank Tops" />
            ...
            <section className="h-auto p-10 text-primary font-montserrat leading-relaxed tracking-wider">
                ...
                <div>
                    ...
                    <div>
                    <img src={cat1} alt="tank-top-catalogue" className="max-w-full"/>
                    <img src={cat2} alt="tank-top-catalogue" className="max-w-full"/>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <table className="text-left table-auto text-md md:text-xl">
                        ...
                        <tr>
                            ...
                            <td className="border border-black p-3"> Tank Tops </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="border border-black p-3"> 100% Cotton,bio wash and silicone jersey </td>
                        </tr>
                    ...
                    <a href="https://drive.google.com/file/d/1iQf1ehReqHdYYvvq2n_VSUeQk9nRJUMY/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="p-4 my-5 border border-black font-montserrat text-primary inline-block transition duration-600 hover:bg-primary hover:text-white"> Download Brouchure </a>
                </div>
            </section>
