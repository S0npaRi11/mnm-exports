...
import cat1 from '../../../Static/Products/Hoodies/catalogue/opt/1.webp'
...
const index = () => {
    return (
        ...
        <Suspense fallback={<Loader />}>
            ...
            <Helmet>
                <title> Hoodies - Products - MNM Exports </title>
                <meta
                name="description" 
            ...
            <section className="h-auto p-10 text-primary font-montserrat leading-relaxed tracking-wider">
                ...
                <div>
                    ...
                    <div>
                        <img src={cat1} alt="hoodies-catalogue" className="max-w-full"/>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <table className="text-left table-auto text-md md:text-xl">
                        ...
                        <tr>
                            ...
                            <td className="border border-black p-3"> Hoodies </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="border border-black p-3"> 100% compact cotton,double bio wash and silicone finish, fleece and terry </td>
                        </tr>

                        <tr>
                            <th className="border border-black p-3"> GSM </th>
                            <td className="border border-black p-3"> 260 - 300 </td>
                        </tr>
                    ...
                    <a href="https://drive.google.com/file/d/1LOqxNH1fqhWOM93n_BlEo0P9io3EOuFS/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="p-4 my-5 border border-black font-montserrat text-primary inline-block transition duration-600 hover:bg-primary hover:text-white"> Download Brouchure </a>
                </div>
            </section>
